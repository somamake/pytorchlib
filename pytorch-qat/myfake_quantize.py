...
from myobserver import (
    Pow2MinMaxObserver,
    Pow2MovingAverageMinMaxObserver,
    Pow2MovingAveragePerChannelMinMaxObserver,
    Pow2PerChannelMinMaxObserver,
)
import re
...
class Pow2FakeQuantizeBase(ABC, Module):
...
class Pow2FakeQuantize(Pow2FakeQuantizeBase):
    ...
    * :attr:`dtype` specifies the quantized dtype that is being emulated with fake-quantization,
    ...
    def __init__(self, observer=Pow2MovingAverageMinMaxObserver, quant_min=0, quant_max=255, **observer_kwargs):
        super().__init__()
    ...
    def _save_to_state_dict(self, destination, prefix, keep_vars):
        ...
        super(Pow2FakeQuantize, self)._save_to_state_dict(destination, prefix, keep_vars)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        super(Pow2FakeQuantize, self)._load_from_state_dict(state_dict, prefix, local_metadata, strict,
                                                        missing_keys, unexpected_keys, error_msgs)


class ApFusedMovingAvgObsFakeQuantize(Pow2FakeQuantize):
    ...
    def __init__(
        self,
        observer: Any = Pow2MovingAverageMinMaxObserver,
        quant_min: int = 0,
        quant_max: int = 255,
        **observer_kwargs: Any
    ) -> None:
        super().__init__(observer, quant_min, quant_max, **observer_kwargs)
        assert isinstance(self.activation_post_process, (Pow2MovingAverageMinMaxObserver, Pow2MovingAveragePerChannelMinMaxObserver,MovingAverageMinMaxObserver,MovingAveragePerChannelMinMaxObserver)),\
        ...
        # self.activation_post_process.quant_min, self.activation_post_process.quant_max = self.quant_min, self.quant_max
